...
} = require("../shipping/melhorenvio-auth");
...
function renderMelhorEnvioCallbackPage({
  title,
  message,
  tone = "success",
  detail = "",
...
shippingRouter.get("/shipping/melhorenvio/status", requireAdmin, async (_req: any, res: any) => {
  try {
...
shippingRouter.get("/shipping/melhorenvio/connect", requireAdmin, async (req: any, res: any) => {
  try {
...
shippingRouter.get("/shipping/melhorenvio/callback", async (req: any, res: any) => {
