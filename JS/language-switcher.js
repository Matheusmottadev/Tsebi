(() => {
  ...
  const TEXT_MAP_EN = {
    ...
    "Carrinho": "Cart",
    "Voltar": "Back",
    "Voltar para inÃ­cio": "Back to home",
    "sair do carreira": "Exit careers",
    "Voltar para a loja": "Back to shop",
    "Frete GrÃ¡tis!": "Free shipping!",
    "Nova ColeÃ§Ã£o GÃªnesis": "New Genesis Collection",
    "VocÃª merece vestir algo Ã  sua altura.": "You deserve to wear something worthy of you.",
    "Cadastre-se para receber lanÃ§amentos": "Sign up to receive launches",
    "Exclusividade para quem valoriza o que Ã© Ãºnico.": "Exclusivity for those who value what is unique.",
    "Acesso antecipado a novas coleÃ§Ãµes.": "Early access to new collections.",
    "ProduÃ§Ã£o em pequena escala. Qualidade em cada detalhe.": "Small-scale production. Quality in every detail.",
    "ColeÃ§Ã£o GÃªnesis": "Genesis Collection",
    "ColeÃ§Ã£o": "Collection",
    "PeÃ§as com construÃ§Ã£o autoral, acabamento refinado e ediÃ§Ã£o limitada.": "Pieces with signature construction, refined finishing, and limited release.",
    "VER COLEÃ‡ÃƒO": "VIEW COLLECTION",
    "CONHEÃ‡A": "DISCOVER",
    "NEWS": "NEWS",
    "Ver tudo": "View all",
    "Leia mais": "Read more",
    ...
    "FragrÃ¢ncias para ele": "Fragrances for him",
    "FragrÃ¢ncias para ela": "Fragrances for her",
    "SUGESTÃ•ES": "SUGGESTIONS",
    ...
    "SERVIÃ‡OS EXCLUSIVOS": "EXCLUSIVE SERVICES",
    "ServiÃ§os Tsebi": "Tsebi Services",
    "Acompanhe seu pedido": "Track your order",
    "Meus dados": "My details",
    "Favoritos": "Favorites",
    "HistÃ³rico de compras": "Purchase history",
    "Sair": "Sign out",
    "Insira seu e-mail": "Enter your email",
    "PrÃ³ximo": "Next",
    ...
    "Adicione peÃ§as para montar seu pedido.": "Add items to build your order.",
    ...
    "ConfiguraÃ§Ãµes de cookies": "Cookie settings",
    "Termos de venda": "Terms of sale",
    "TERMOS E CONDIÃ‡Ã•ES LEGAIS": "LEGAL TERMS AND CONDITIONS",
    "EMPRESA": "COMPANY",
    "FaÃ§a parte do time Tsebi": "Join the Tsebi team",
    ...
    "NÃ£o especificada": "Not specified",
    "Jaqueta bomber em couro italiano com forro em seda": "Italian leather bomber jacket with silk lining",
    "CalÃ§a de alfaiataria em sarja premium estruturada": "Premium structured tailored twill pants",
    "Camisa em algodÃ£o croata de trama nobre": "Croatian cotton shirt with noble weave",
    "Saia estruturada em lÃ£ fria de acabamento impecÃ¡vel": "Structured cool wool skirt with impeccable finish",
    ...
    "Trench coat em gabardine com corte arquitetÃ´nico": "Gabardine trench coat with architectural cut",
    ...
    "TÃªnis em nylon tÃ©cnico e couro de acabamento premium": "Technical nylon and premium-finish leather sneaker",
    "Blazer em linho premium com alfaiataria de precisÃ£o": "Premium linen blazer with precision tailoring",
    "CalÃ§a wide leg em linho premium com prega profunda": "Premium linen wide-leg trousers with deep pleat",
    "Sabrina charmosa": "Charming Sabrina",
    "Sabrina linda": "Elegant Sabrina",
    "Sabrina maravilhosa": "Stunning Sabrina",
    "Sabrina incrÃ­vel": "Incredible Sabrina",
    "Oportunidades em aberto": "Open roles",
    "Plano de carreira": "Career path",
    "Cultura e benefÃ­cios": "Culture and benefits",
    "Banco de talentos": "Talent pool",
    "JUNTE-SE A NÃ“S": "JOIN US",
    "CARREIRAS": "CAREERS",
    "HÃ¡ uma raiz que sustenta tudo o que escolhemos ser. Porque estilo nÃ£o Ã© sobre o que vocÃª veste, Ã© sobre quem vocÃª Ã©.": "There is a root that sustains everything we choose to be. Style is not about what you wear, it is about who you are.",
    "HÃ¡ uma raiz que sustenta tudo o que escolhemos ser. Porque estilo nÃ£o Ã© sobre o que vocÃª veste, Ã© sobre quem vocÃª Ã©": "There is a root that sustains everything we choose to be. Style is not about what you wear, it is about who you are.",
    "Feminino": "Women",
    "Masculino": "Men"
  };
  ...
  const PLACEHOLDER_MAP_EN = {
    ...
    "O que vocÃª estÃ¡ buscando?": "What are you looking for?",
    "Conte sua experiÃªncia e por que quer fazer parte da Tsebi.": "Share your experience and why you want to join Tsebi.",
  ...
  function mountSwitcher() {
    ...
    ptBtn.setAttribute("aria-label", "PortuguÃªs");
  ...
  document.addEventListener("DOMContentLoaded", () => {
    mountSwitcher();
    applyLanguage();
    // Reaplica apÃ³s scripts da pÃ¡gina concluÃ­rem renderizaÃ§Ãµes tardias.
